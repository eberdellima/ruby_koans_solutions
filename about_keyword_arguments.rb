...
class AboutKeywordArguments < Neo::Koan
  ...
  def test_keyword_arguments
    assert_equal AboutKeywordArguments, method_with_keyword_arguments.class
  ...
  def test_keyword_arguments_with_wrong_number_of_arguments
    ...
    assert_match(/method_with_keyword_arguments_with_mandatory_argument/, exception.message)
  end
